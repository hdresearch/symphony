defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Vers do
    ...
    embedded_schema do
      ...
      field(:golden_commit, :string)
      field(:max_runtime_ms, :integer, default: 1_800_000)  # 30 minutes
    end

    @spec changeset(%__MODULE__{}, map()) :: Ecto.Changeset.t()
    def changeset(schema, attrs) do
      schema
      |> cast(attrs, [:enabled, :golden_commit, :max_runtime_ms], empty_values: [])
  ...
  embedded_schema do
    ...
    embeds_one(:vers, Vers, on_replace: :update, defaults_to_struct: true)
  end
  ...
  defp changeset(attrs) do
    ...
    |> cast_embed(:vers, with: &Vers.changeset/2)
  end
